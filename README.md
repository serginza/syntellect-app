...
Приложение построенно на React + TypeScript + MobX.

Локальный запуск: клонировать репозиторий на диск, выполнить установку зависимостей (npm intall или yarn install), запустить проект командой **"npm run start"**.

Deploy: https://serginza.github.io/syntellect-app
